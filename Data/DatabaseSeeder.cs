    ...
    public static class DatabaseSeeder
    {
        public static void SeedData(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<CustomerEntity>().HasData(
                new CustomerEntity { CustID = 1, CompanyName = "Company A", ContactFirstNames = "John", ContactSurname = "Doe", ContactTitle = "Mr.", Email = "john.doe@companya.com", Telephone = "07123 456789", Fax = "01234 567890", Line1 = "123 Main St", Line2 = "", Line3 = "", Line4 = "", Postcode = "SO14 1KX" },
                new CustomerEntity { CustID = 2, CompanyName = "Company B", ContactFirstNames = "Jane", ContactSurname = "Smith", ContactTitle = "Ms.", Email = "jane.smith@companyb.com", Telephone = "07234 567890", Fax = "01345 678901", Line1 = "456 Oak Ave", Line2 = "", Line3 = "", Line4 = "", Postcode = "PL4 6LU" },
                new CustomerEntity { CustID = 3, CompanyName = "Company C", ContactFirstNames = "Mike", ContactSurname = "Johnson", ContactTitle = "Mr.", Email = "mike.johnson@companyc.com", Telephone = "07345 678901", Fax = "01456 789012", Line1 = "789 Pine Rd", Line2 = "", Line3 = "", Line4 = "", Postcode = "PO1 8VI" },
                new CustomerEntity { CustID = 4, CompanyName = "Company D", ContactFirstNames = "Sarah", ContactSurname = "Williams", ContactTitle = "Mrs.", Email = "sarah.williams@companyd.com", Telephone = "07456 789012", Fax = "01567 890123", Line1 = "321 Elm St", Line2 = "", Line3 = "", Line4 = "", Postcode = "CT3 8AB" },
                new CustomerEntity { CustID = 5, CompanyName = "Company E", ContactFirstNames = "David", ContactSurname = "Brown", ContactTitle = "Mr.", Email = "david.brown@companye.com", Telephone = "07567 890123", Fax = "01678 901234", Line1 = "654 Maple Dr", Line2 = "", Line3 = "", Line4 = "", Postcode = "TR2 7VM" },
                new CustomerEntity { CustID = 6, CompanyName = "Company F", ContactFirstNames = "Lisa", ContactSurname = "Davis", ContactTitle = "Ms.", Email = "lisa.davis@companyf.com", Telephone = "07678 901234", Fax = "01789 012345", Line1 = "987 Cedar Ln", Line2 = "", Line3 = "", Line4 = "", Postcode = "SW1 5RZ" },
                new CustomerEntity { CustID = 7, CompanyName = "Company G", ContactFirstNames = "Robert", ContactSurname = "Miller", ContactTitle = "Mr.", Email = "robert.miller@companyg.com", Telephone = "07789 012345", Fax = "01890 123456", Line1 = "147 Birch Way", Line2 = "", Line3 = "", Line4 = "", Postcode = "SW9 1JP" },
                new CustomerEntity { CustID = 8, CompanyName = "Company H", ContactFirstNames = "Jennifer", ContactSurname = "Wilson", ContactTitle = "Mrs.", Email = "jennifer.wilson@companyh.com", Telephone = "07890 123456", Fax = "01901 234567", Line1 = "258 Spruce St", Line2 = "", Line3 = "", Line4 = "", Postcode = "SW2 9FA" },
                new CustomerEntity { CustID = 9, CompanyName = "Company I", ContactFirstNames = "Michael", ContactSurname = "Moore", ContactTitle = "Mr.", Email = "michael.moore@companyi.com", Telephone = "07901 234567", Fax = "01012 345678", Line1 = "369 Willow Ave", Line2 = "", Line3 = "", Line4 = "", Postcode = "PO3 8UT" },
                new CustomerEntity { CustID = 10, CompanyName = "Company J", ContactFirstNames = "Amanda", ContactSurname = "Taylor", ContactTitle = "Ms.", Email = "amanda.taylor@companyj.com", Telephone = "07012 345678", Fax = "01123 456789", Line1 = "741 Poplar Rd", Line2 = "", Line3 = "", Line4 = "", Postcode = "PL4 9DV" }
            );
